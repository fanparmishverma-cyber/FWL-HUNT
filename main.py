...
    if not data:
        update.message.reply_text("❌ Failed to fetch clan")
        return
...
    tracked = "✅ YES" if clan in tracked_clans else "❌ NO"
...
updater.idle()    elif state == "preparation":
        war_status = "⚔ Preparation Day"
...
updater.start_polling()
updater.idle()        war_status = "❌ Not In War"
